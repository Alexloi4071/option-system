...
class OptionsAnalysisSystem:
    ...
    def run_complete_analysis(self, ticker: str, expiration: str = None, 
        ...
        返回:
            dict: 完整分析結果
        """
        # 進度報告輔助函數 - 使用統一的 TOTAL_ANALYSIS_STEPS
        def report_progress(step, message, module_name=None):
            """
            報告分析進度
            ...
            Note:
                total 參數已內部固定為 TOTAL_ANALYSIS_STEPS，確保進度一致性
            """
            if progress_callback:
                try:
                    progress_callback(step, TOTAL_ANALYSIS_STEPS, message, module_name)
                except Exception as e:
        ...
        try:
            ...
            # 第2步: 驗證數據
            report_progress(2, "驗證數據完整性...", "數據驗證")
            logger.info("\n→ 第2步: 驗證數據完整性...")
            ...
            report_progress(4, "計算 PE 估值...", "Module 4: PE估值")
            try:
            ...
            # 模塊11: 合成正股（支持股息調整）
            report_progress(11, "計算合成正股...", "Module 11: 合成正股")
            try:
            ...
            report_progress(14, "計算監察崗位...", "Module 14: 監察崗位")
            try:
            ...
            # ========== 新增模塊 (Module 15-19) ==========
            report_progress(15, "計算期權定價與 Greeks...", "Module 15-19: 期權定價")
            logger.info("\n→ 運行新增模塊 (Module 15-19)...")
            ...
            # ========== 模塊21: 動量過濾器 (新增) ==========
            report_progress(20, "計算基本面健康...", "Module 20: 基本面健康")
            report_progress(21, "計算動量過濾器...", "Module 21: 動量過濾器")
            logger.info("\n→ 運行 Module 21: 動量過濾器...")
            ...
            report_progress(22, "計算動態 IV 閾值...", "Module 23: 動態IV閾值")
            ...
            report_progress(24, "分析高級組合策略...", "Module 32: 組合策略")
            ...
            # ========== 模塊24: 技術方向分析 ==========
            report_progress(25, "分析技術方向...", "Module 24: 技術方向")
            logger.info("\n→ 運行 Module 24: 技術方向分析...")
            ...
            # Module 25: 波動率微笑分析
            report_progress(26, "分析波動率微笑...", "Module 25: 波動率微笑")
            ...
            # Module 26: Long 期權成本效益分析
            report_progress(27, "分析 Long 期權成本效益...", "Module 26: Long期權分析")
            ...
            report_progress(28, "比較多個到期日...", "Module 27: 多到期日比較")
            ...
            report_progress(29, "計算資金倉位...", "Module 28: 資金倉位")
