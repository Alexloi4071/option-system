...
def test_ibkr_connection():
    ...
    try:
        ...
        if client.connect(timeout=15):
            ...
            # 測試 1: 獲取期權報價 (OPRA 數據)
            print("\n--- 測試 1: 獲取期權報價 (OPRA) ---")
            quote = client.get_option_quote('META', 650.0, '2026-01-16', 'C')
            if quote:
                print(f"✓ 獲取期權報價成功:")
            ...
            # 測試 2: 獲取 Greeks (可能需要額外訂閱)
            print("\n--- 測試 2: 獲取 Greeks ---")
            greeks = client.get_option_greeks('META', 650.0, '2026-01-16', 'C')
            if greeks:
            ...
            # 測試 3: 獲取 Bid/Ask 價差
            print("\n--- 測試 3: 獲取 Bid/Ask 價差 ---")
            spread = client.get_bid_ask_spread('META', 650.0, '2026-01-16', 'C')
